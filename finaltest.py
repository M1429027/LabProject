...
def main():
    ...
    # ---------------------------------------------------------
    # 邏輯：圍繞 Z 軸旋轉。
    # 假設 X軸為右，Y軸為前 (或根據原程式碼邏輯)
    # 原程式碼 Cam1: sin(45), -cos(45) -> X+, Y- (第四象限/右後?) 或 X+, Y+ (視座標系而定)
    # 為了確保覆蓋，我們定義 4 個象限: (+,+), (+,-), (-,+), (-,-)
    
    camera_configs = [
        {
            "id": "cam1",
            "name": "Front-Right (45°)", # 假設 ++
            "angle_signs": (1, 1),       # X sign, Y sign
            "folder": "camera1_front_right"
        },
        {
            "id": "cam2",
            "name": "Front-Left (135°)", # 假設 -+
            "angle_signs": (-1, 1),
            "folder": "camera2_front_left"
        },
        {
            "id": "cam3",
            "name": "Back-Left (225°)",  # 假設 --
            "angle_signs": (-1, -1),
            "folder": "camera3_back_left"
        },
        {
            "id": "cam4",
            "name": "Back-Right (315°)", # 假設 +-
            "angle_signs": (1, -1),
            "folder": "camera4_back_right"
        }
    ]
